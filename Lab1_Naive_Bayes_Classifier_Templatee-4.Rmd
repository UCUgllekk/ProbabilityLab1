...
naiveBayes <- setRefClass("naiveBayes",
  ...
  methods = list(
    fit = function(X, y) {
      ...
      # Calculate class probabilities (prior)
      ...
      # Calculate feature probabilities for each word with Laplace smoothing
    ...
    score = function(X_test, y_test) {
      ...
      FP <- 0
      FN <- 0
      failures <- list()  # To store failure cases
      ...
      for (i in 1:total_predictions) {
        ...
        # Skip if the predicted value is NA
      ...
      # Return metrics and failure cases
